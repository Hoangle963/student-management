...
<nav class="main-nav" id="main-nav">
    <a class="active" href="display_sinhvien">Trang chủ</a>
    <a class="active" href="logout.php">Đăng Xuất</a>
    <span class="ten">Sinh viên</span>
    <a href="display_sinhvien">Thông tin</a>
    <a href="index.php">Danh sách điểm</a>
    <a href="display_mon.php">Danh sách học phần đã đăng kí</a>
    <a href="display_phuckhao.php">Phúc khảo điểm</a>
</nav>
