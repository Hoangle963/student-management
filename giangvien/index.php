...
if ($_SESSION['chucvu'] != "giangvien") {
    ...
    echo "<script>window.location.href='/qlsv/index.php';</script>";
    exit;
}
...
<nav class="main-nav" id="main-nav">
    ...
    <a href="diem_lop">Danh sách điểm</a>
    <a href="diem">Thêm điểm</a>
    <a href="display_sinhvien">Thêm điểm theo lớp, môn</a>
